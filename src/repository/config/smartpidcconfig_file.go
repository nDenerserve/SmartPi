...
func (p *DCconfig) SaveDCParameterToFile() {
	...
	// [calculations]
power_1", strings.Join(utils.Int2StringSlice(p.Power[0][:]), "|"))
power_2", strings.Join(utils.Int2StringSlice(p.Power[1][:]), "|"))
power_3", strings.Join(utils.Int2StringSlice(p.Power[2][:]), "|"))
power_name_1", p.PowerName[0])
power_name_2", p.PowerName[1])
power_name_3", p.PowerName[2])
energy_production_name_1", p.EnergyProductionName[0])
energy_production_name_2", p.EnergyProductionName[1])
energy_production_name_3", p.EnergyProductionName[2])
energy_consumption_name_1", p.EnergyConsumptionName[0])
energy_consumption_name_2", p.EnergyConsumptionName[1])
energy_consumption_name_3", p.EnergyConsumptionName[2])
energy_balanced_name_1", p.EnergyBalancedName[0])
energy_balanced_name_2", p.EnergyBalancedName[1])
energy_balanced_name_3", p.EnergyBalancedName[2])
