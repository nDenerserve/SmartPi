...
char value, phase,current_read, voltage_read, power_read,cosphi_read, frequenz_read, phase_write, number;
...
current_read=atoi(argv[2]);
//printf("\r\nEingabe Current %i\r\n",current_read);
voltage_read=atoi(argv[3]);
//printf("\r\nEingabe Voltage %i\r\n",voltage_read);
power_read=atoi(argv[4]);
//printf("\r\nEingabe Power %i\r\n",power_read);
cosphi_read=atoi(argv[5]);
//printf("\r\nEingabe CosPhi %i\r\n",cosphi_read);
frequenz_read=atoi(argv[6]);
//printf("\r\nEingabe Frequenz %i\r\n",frequenz_read);
phase=atoi(argv[7]);
//printf("\r\nEingabe Phase %i\r\n",phase);
