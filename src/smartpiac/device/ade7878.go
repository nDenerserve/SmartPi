...
var MainPhases = []models.SmartPiPhase{models.PhaseA, models.PhaseB, models.PhaseC}
...
func InitADE7878(c *config.SmartPiACConfig) (*i2c.Device, error) {
...
func ReadCurrent(d *i2c.Device, c *config.SmartPiACConfig, phase models.SmartPiPhase) (current float64) {
	command := make([]byte, 2)
	switch phase {
	case models.PhaseA:
...
func ReadVoltage(d *i2c.Device, c *config.SmartPiACConfig, phase models.SmartPiPhase) (voltage float64, measureVoltage bool) {
	command := make([]byte, 2)
	switch phase {
	case models.PhaseA:
...
func ReadActiveWatts(d *i2c.Device, c *config.SmartPiACConfig, phase models.SmartPiPhase) (watts float64) {
	command := make([]byte, 2)
	switch phase {
	case models.PhaseA:
...
func ReadActiveEnergy(d *i2c.Device, c *config.SmartPiACConfig, phase models.SmartPiPhase) (energy float64) {
	command := make([]byte, 2)
	switch phase {
	case models.PhaseA:
...
func ReadAngle(d *i2c.Device, c *config.SmartPiACConfig, phase models.SmartPiPhase) (angle float64) {
	command := make([]byte, 2)
	switch phase {
	case models.PhaseA:
...
func ReadFrequency(d *i2c.Device, c *config.SmartPiACConfig, phase models.SmartPiPhase) (frequency float64) {
	command := make([]byte, 2)
	switch phase {
	case models.PhaseA:
...
func ReadApparentPower(d *i2c.Device, c *config.SmartPiACConfig, phase models.SmartPiPhase) float64 {
	command := make([]byte, 2)
	switch phase {
	case models.PhaseA:
...
func ReadReactivePower(d *i2c.Device, c *config.SmartPiACConfig, phase models.SmartPiPhase) (rewatts float64) {
	command := make([]byte, 2)
	switch phase {
	case models.PhaseA:
...
func CalculatePowerFactor(c *config.SmartPiACConfig, phase models.SmartPiPhase, watts float64, voltAmps float64, voltAmpsReactive float64) float64 {
...
func ReadPhase(d *i2c.Device, c *config.SmartPiACConfig, p models.SmartPiPhase, measureFrequency bool, v *models.ADE7878Readout) {
	startTime := time.Now()
